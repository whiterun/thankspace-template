					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							...
							<p>
								...
								<i class="mdi-av-video-collection"></i> <span>Watch Our Video</span> </a>
								&#32;&#32;
								<a id="step1" class="btn btn-warning btn-lg" href="javascript:void(0);" onclick="startIntro();"><i class="mdi-maps-directions-walk"></i> <span>Quick Tour</span></a>
								<!-- onclick="javascript:introJs().setOption('showBullets', false).setOption('showProgress', true).start();"
								<a class="btn btn-primary btn-lg"><i class="mdi-av-video-collection"></i>  Overseas Travellers</a>-->
							</p>
